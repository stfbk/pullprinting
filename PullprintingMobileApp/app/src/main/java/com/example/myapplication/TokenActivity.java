...
*/
    ...
    private Response requestQueuePrinter(String authToken) throws IOException {
        ...
        OkHttpClient client = new OkHttpClient();
        Request request = new Request.Builder()
                .url("https://"+Commons.ipaddress + "/list_printer?access_token=" + authToken) //prima era printer se non stampanti admin
                .get()
                .addHeader("cache-control", "no-cache")
    ...
    private Response requestPrint(String accessToken, String jobID, String printerID) throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://"+Commons.ipaddress+"/print_token_easy")
                .post(body)
    ...
    private Response requestModelPrinters(String authToken) throws IOException {
        OkHttpClient client = new OkHttpClient();
        Request request = new Request.Builder()
                .url("https://"+Commons.ipaddress + "/printer_model?printer_id=" + Commons.acutalPrinter+"&access_token="+authToken) //prima era printer se non stampanti admin
                .get()
                .build();
        //Response response = client.newCall(request).execute();
        return client.newCall(request).execute();
